...
class VolumeProfileEngine:
    ...
    def analyze(
        ...
        for idx, row in profile_df.iterrows():
            ...
            ntype = "NORMAL"
            if abs(p - poc_price) < bin_size / 2: ntype = "POC"
            elif any(abs(p - h) < bin_size / 2 for h in hvn_levels): ntype = "HVN"
            elif any(abs(p - l) < bin_size / 2 for l in lvn_levels): ntype = "LVN"
