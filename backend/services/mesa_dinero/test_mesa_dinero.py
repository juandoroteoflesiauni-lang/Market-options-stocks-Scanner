...
from backend.services.mesa_dinero.report_factory import SpecializedReportGenerator
...
def test_mesa_dinero_orchestrator_smoke() -> None:
    ...
    from backend.services.mesa_dinero.orchestrator import MesaDineroOrchestrator
