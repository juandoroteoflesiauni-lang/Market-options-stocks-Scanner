...
logger = logging.getLogger("backend.layer_3_specialists.fundamentales.pillar_scorer")

from ..ia_probabilistico.engines.sentiment_engine import SentimentEngine
