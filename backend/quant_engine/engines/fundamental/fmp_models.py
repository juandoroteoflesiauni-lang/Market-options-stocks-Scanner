...
"""Pydantic models para respuestas de Financial Modeling Prep."""
...
class FMPSegmentData(BaseModel):
    ...
    date: str
    symbol: str
    # Usually keys are dynamically named (e.g. "iPhone", "Services")
    # We'll use extra="allow" or a dict for dynamic mapping in client if needed.
    # Actually most segment lookups return a dict of {key: value}
