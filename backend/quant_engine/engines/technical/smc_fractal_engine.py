...
class SMCFractalEngine:
    ...
    def analyze(
        ...
        try:
            ...
            entropy_series = TechnicalMath.shannon_entropy(
                log_returns, n=_ENTROPY_WINDOW, bins=_ENTROPY_BINS
            )
            ...
            bias = "CASH"
            if is_ordered:
                bullish_evidence = (fvg_active and fvg_direction == "BULLISH") or (
                    is_institutional and impulse_bullish
                )
                bearish_evidence = (fvg_active and fvg_direction == "BEARISH") or (
