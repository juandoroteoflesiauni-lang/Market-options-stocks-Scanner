...
from ..layer_3_specialists.ia_probabilistico.engines.catalyst_nlp_engine import CatalystNLPEngine
from ..layer_3_specialists.ia_probabilistico.engines.cnn_fear_greed import (
    get_alternative_source,
    get_cnn_fetcher,
)
from ..layer_3_specialists.ia_probabilistico.engines.cor3m_engine import COR3M_Signal_Engine
from ..layer_3_specialists.ia_probabilistico.engines.correlation_analyzer import (
    get_correlation_analyzer,
)
from ..layer_3_specialists.ia_probabilistico.engines.cross_asset_engine import (
    REFERENCE_ASSETS,
    CrossAssetEngine,
)
from ..layer_3_specialists.ia_probabilistico.engines.delta_weighted_flow_engine import (
    DeltaWeightedFlow_Engine,
)
from ..layer_3_specialists.ia_probabilistico.engines.dex_engine import DeltaExposureEngine
from ..layer_3_specialists.ia_probabilistico.engines.expected_move_engine import ExpectedMoveEngine
from ..layer_3_specialists.ia_probabilistico.engines.factor_calibration import (
    get_calibration_engine,
)
from ..layer_3_specialists.ia_probabilistico.engines.fear_greed_engine import FearGreedEngine
from ..layer_3_specialists.ia_probabilistico.engines.fear_greed_storage import get_fg_storage
from ..layer_3_specialists.ia_probabilistico.engines.feedback_engine import FeedbackCalibration
from ..layer_3_specialists.ia_probabilistico.engines.market_data_fetcher import MarketDataFetcher
from ..layer_3_specialists.ia_probabilistico.engines.markov_regime_engine import MarkovRegimeEngine
from ..layer_3_specialists.ia_probabilistico.engines.ml_optimizer import get_ml_optimizer
from ..layer_3_specialists.ia_probabilistico.engines.probabilistic_engine import (
...
from ..layer_3_specialists.ia_probabilistico.engines.regime_weights import get_regime_engine
from ..layer_3_specialists.ia_probabilistico.engines.sentiment_engine import SentimentEngine
from ..layer_3_specialists.ia_probabilistico.engines.skew_fattails_engine import SkewFatTailsEngine
from ..layer_3_specialists.ia_probabilistico.engines.squeeze_engine import (
    OptionChainData,
    SqueezeIgnitionEngine,
    SqueezeState,
    UnderlyingData,
)
from ..layer_3_specialists.ia_probabilistico.engines.vol_term_engine import (
    VolatilityTermStructureEngine,
)
from ..layer_3_specialists.ia_probabilistico.engines.volatility_surface_engine import (
    VolatilitySurfaceEngine,
)
from ..layer_3_specialists.ia_probabilistico.engines.volume_oi_engine import OptionsMarketAnalyzer
from ..layer_3_specialists.ia_probabilistico.engines.volume_profile_engine import (
    VolumeProfileEngine,
)
...
def _create_multimodal_predictive_engine() -> Any:
    try:
        from ..layer_3_specialists.ia_probabilistico.engines.multimodal_predictive import (
...
def _downsample_gamma_profile(
    prices: np.ndarray, gammas: np.ndarray, max_points: int = 280
...
def _gamma_flip_response_from_snap(sym: str, opt_snap: Any) -> GammaFlipResponse:
    ...
    from ..layer_3_specialists.ia_probabilistico.engines.gamma_flip_engine import GammaFlipEngine
...
def _shadow_delta_response_from_snap(
    ...
    *,
    ...
    from ..layer_3_specialists.ia_probabilistico.engines.shadow_delta_engine import (
        ShadowDeltaEngine,
    )
...
def _zomma_response_from_portfolio(
    ...
    from ..layer_3_specialists.ia_probabilistico.engines.zomma_engine import compute_zomma_bundle
...
def _speed_instability_from_portfolio(
    ...
    from ..layer_3_specialists.ia_probabilistico.engines.speed_instability_engine import (
...
def _zero_day_gamma_wall_from_snap(
    ...
    from ..layer_3_specialists.ia_probabilistico.engines.zero_day_engine import (
...
def _tail_risk_smile_from_portfolio(
    ...
    from ..layer_3_specialists.ia_probabilistico.engines.tail_risk_engine import (
...
def _volatility_skew_from_portfolio(
    ...
    from ..layer_3_specialists.ia_probabilistico.engines.volatility_skew_engine import (
...
async def get_probabilistic_analysis(
    ...
    try:
        ...
        _kelly = calculate_kelly_sizing(win_prob, payoff_b)
...
async def get_price_targets(symbol: str, include_ai: bool = False) -> dict[str, Any]:
    ...
    try:
        ...
        tail_res = eng_results[0]
        mjd_params = eng_results[1]
        pf_res = eng_results[2]
        ...
        if include_ai:
            ...
            from ..layer_4_orchestration.ai_core.agent_manager import AgentManager
...
from ..layer_3_specialists.ia_probabilistico.engines.portfolio_optimizer import (
    ...
    try:
        ...
        for ref_ticker, res in zip(ref_tasks.keys(), ref_results, strict=False):
            if isinstance(res, list) and res:
                ref_prices[ref_ticker] = [p.close for p in res if p.close]

        ca_report = _get_cross_asset_engine().analyze(sym, target_prices, ref_prices)
...
async def get_risk_neutral_density_endpoint(
    ...
    try:
        from ..layer_3_specialists.ia_probabilistico.engines.risk_neutral_density_engine import (
...
async def get_dealer_flow_endpoint(
    ...
    try:
        from ..layer_3_specialists.ia_probabilistico.engines.dealer_flow_dynamics_engine import (
...
async def get_options_flow_toxicity_endpoint(
    ...
    try:
        from ..layer_3_specialists.ia_probabilistico.engines.options_order_flow_toxicity_engine import (
...
async def get_macro_regime_prior_endpoint(symbol: str) -> MacroRegimePriorResponse:
    ...
    try:
        from ..layer_3_specialists.ia_probabilistico.engines.macro_regime_prior_engine import (
